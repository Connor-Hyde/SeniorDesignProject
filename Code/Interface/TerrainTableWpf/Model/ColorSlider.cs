...
namespace TerrainTableWpf.Model
{
    public class ColorSlider : Slider
    {
        ...
        public static readonly DependencyProperty SelectedColoursProperty =
            DependencyProperty.Register("SelectedColour", typeof(Color), typeof(ColorSlider),
        ...
        private void CacheBitmap()
        {
            ...
            RenderTargetBitmap source = new RenderTargetBitmap(200, 200, 96, 96, PixelFormats.Pbgra32);
        ...
        {
            ColorSlider colourSlider = (ColorSlider)property;
